...
<head>
	...
	<div class="container-fluid">
		...
		<div class="declearation">
			<h2>HEY!</h2>
			<h4>This is only a <span>DEMO</span> bokking system, allowing users' <span>registeration&nbsp;|&nbsp;login&nbsp;|&nbsp;searching&nbsp;|&nbsp;booking&nbsp;|&nbsp;delete</span> operations.</h2>
			<h4>Information are fake and just created for testing.</h3>
			<h4>There are two hotelNames available in database: <span>Qinglv</span> and <span>Suba</span></h4>
			<h4>And two hotelLocations available: <span>Waterloo</span> and <span>Kitchener</span></h4>
			<h4><span>Tips:</span> unknown users are able to SEARCH but cannot execute BOOKING without a loggedin account</h4>
		</div>
